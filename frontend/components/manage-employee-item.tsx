...
export default function ManageEmployeeArrangementsItem({ params }: ManageEmployeeArrangementsItemProps) {
    const [employeeRequests, setEmployeeRequests] = useState<IndividualRequest[]>([])
    const mockEmployeeRequest = [
        { id: 1, type: "AM", date: "2023-06-01", status: "pending", remarks: "remarks" },
        { id: 2, type: "PM", date: "2023-06-02", status: "pending", remarks: "remarks" },
        { id: 3, type: "AM", date: "2023-06-03", status: "pending", remarks: "remarks" },
      ]
    const request = {
        id: "WFH-001",
    ...
    const handleApprove = async (id: number) => {
        ...
        setEmployeeRequests(employeeRequests.map(req => 
