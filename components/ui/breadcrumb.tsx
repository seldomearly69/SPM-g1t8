...
const Breadcrumb = React.forwardRef<HTMLDivElement, React.ComponentPropsWithoutRef<"nav"> & {
...
export { Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbSeparator, BreadcrumbEllipsis }